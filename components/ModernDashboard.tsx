...
export default function ModernDashboard({ title, totalGames, completedGames, action, children }: ModernDashboardProps) {
    ...
    return (
        <div className="relative mt-8">
            {/* Container with Dot Pattern */}
            <div className="bg-[#E7D6C4]/20 rounded-3xl p-6 border border-[#E7D6C4] relative z-10 overflow-hidden shadow-sm">
                {/* Abstract Mesh Blob (Optional, purely decorative) */}
                <div className="absolute -top-20 -right-20 w-64 h-64 bg-orange-100 rounded-full blur-3xl opacity-50 -z-10" />
