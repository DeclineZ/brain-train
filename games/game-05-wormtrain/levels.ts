...
export const LEVELS: LevelData[] = [
  ...
  // LEVEL 1: First Split — holes left-mid and right-mid
  {
    ...
    nodes: [
      ...
      { id: 'hO', type: 'HOLE', x: 700, y: 300, color: '#ff914d' },
    ],
    edges: [
      { id: 'e1', from: 's', to: 'j1', path: [p(400,-100), p(400,300)], length: 400, widthClass: 'normal' },
      { id: 'e2', from: 'j1', to: 'hB', path: [p(400,300), p(100,300)], length: 300, widthClass: 'normal' },
      { id: 'e3', from: 'j1', to: 'hO', path: [p(400,300), p(700,300)], length: 300, widthClass: 'normal' },
    ],
    junctions: [{ id: 'j1', outEdges: ['e2','e3'], defaultIndex: 1 }],
    traps: [],
    worms: [
  ...
  // LEVEL 2: The Crossing — L-shape, holes at different heights
  {
    levelId: 2, metadata: { name: 'The Crossing', rating: 1 },
    colors: ['#5170ff', '#ff914d'],
    nodes: [
      { id: 's', type: 'SPAWN', x: 400, y: -100 },
      { id: 'j1', type: 'JUNCTION', x: 400, y: 300 },
    ...
    edges: [
      { id: 'e1', from: 's', to: 'j1', path: [p(400,-100), p(400,300)], length: 400, widthClass: 'normal' },
      { id: 'e2', from: 'j1', to: 'hB', path: [p(400,300), p(100,300)], length: 300, widthClass: 'normal' },
      { id: 'e3', from: 'j1', to: 'j2', path: [p(400,300), p(650,300)], length: 250, widthClass: 'normal' },
      { id: 'e4', from: 'j2', to: 'hO', path: [p(650,300), p(650,600)], length: 300, widthClass: 'normal' },
      { id: 'e5', from: 'j2', to: 'hB', path: [p(650,300), p(100,300)], length: 550, widthClass: 'normal' },
    ],
    junctions: [
  ...
  // LEVEL 3: Zig Zag — 3 junctions, holes at left-mid and right-top
  {
    levelId: 3, metadata: { name: 'Zig Zag', rating: 2 },
    colors: ['#5170ff', '#ff914d'],
    nodes: [
      { id: 's', type: 'SPAWN', x: 400, y: -100 },
      { id: 'j1', type: 'JUNCTION', x: 400, y: 250 },
      { id: 'j2', type: 'JUNCTION', x: 100, y: 250 },
      { id: 'j3', type: 'JUNCTION', x: 700, y: 250 },
      { id: 'hB', type: 'HOLE', x: 100, y: 500, color: '#5170ff' },
      { id: 'hO', type: 'HOLE', x: 700, y: 100, color: '#ff914d' },
    ],
    edges: [
      { id: 'e1', from: 's', to: 'j1', path: [p(400,-100), p(400,250)], length: 350, widthClass: 'normal' },
      { id: 'e2', from: 'j1', to: 'j2', path: [p(400,250), p(100,250)], length: 300, widthClass: 'normal' },
      { id: 'e3', from: 'j1', to: 'j3', path: [p(400,250), p(700,250)], length: 300, widthClass: 'normal' },
      { id: 'e4', from: 'j2', to: 'hB', path: [p(100,250), p(100,500)], length: 250, widthClass: 'normal' },
      { id: 'e5', from: 'j2', to: 'hO', path: [p(100,250), p(100,100), p(700,100)], length: 750, widthClass: 'normal' },
      { id: 'e6', from: 'j3', to: 'hO', path: [p(700,250), p(700,100)], length: 150, widthClass: 'normal' },
      { id: 'e7', from: 'j3', to: 'hB', path: [p(700,250), p(700,500), p(100,500)], length: 850, widthClass: 'normal' },
    ],
    junctions: [
  ...
  // LEVEL 4: Triple Choice — 3 holes: left, right, bottom
  {
    levelId: 4, metadata: { name: 'Triple Choice', rating: 2 },
    intro: { title: 'การสลับราง', description: 'กดที่ปุ่มทางแยกเพื่อสลับเส้นทาง\nพาหนอนแต่ละสีไปลงหลุมให้ถูกต้อง!', imageKey: 'spawn' },
    colors: ['#5170ff', '#58CC02', '#ff914d'],
    nodes: [
      { id: 's', type: 'SPAWN', x: 400, y: -100 },
      { id: 'j1', type: 'JUNCTION', x: 400, y: 350 },
      { id: 'hB', type: 'HOLE', x: 100, y: 350, color: '#5170ff' },
      { id: 'hG', type: 'HOLE', x: 400, y: 700, color: '#58CC02' },
      { id: 'hO', type: 'HOLE', x: 700, y: 350, color: '#ff914d' },
    ],
    edges: [
      { id: 'e1', from: 's', to: 'j1', path: [p(400,-100), p(400,350)], length: 450, widthClass: 'normal' },
      { id: 'e2', from: 'j1', to: 'hB', path: [p(400,350), p(100,350)], length: 300, widthClass: 'normal' },
      { id: 'e3', from: 'j1', to: 'hG', path: [p(400,350), p(400,700)], length: 350, widthClass: 'normal' },
      { id: 'e4', from: 'j1', to: 'hO', path: [p(400,350), p(700,350)], length: 300, widthClass: 'normal' },
    ],
