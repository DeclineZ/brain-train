...
import { Loader2, Mail, Lock, Brain, Trophy, Zap, CheckCircle2 } from "lucide-react";
...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen bg-cream flex flex-col md:flex-row-reverse text-brown-800 font-sans">
            {/* Right Side (Desktop) / Top (Mobile) - Login Form */}
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-lg text-brown-600">
                            กรุณาเข้าสู่ระบบเพื่อเริ่มการฝึกสมองของคุณ
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-14 bg-orange-action hover:bg-orange-600 text-white text-xl font-bold rounded-xl shadow-lg shadow-orange-900/10 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="text-center pt-4">
                        <a href="/signup" className="text-lg font-medium text-orange-action hover:text-orange-600 hover:underline underline-offset-4">
                ...
                <div className="max-w-md text-center md:text-left space-y-8">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-brown-900 leading-tight">
                            รักษาความคิดของคุณ <br />
                            <span className="text-orange-action">ให้เฉียบคมและตื่นตัว</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-brown-800 leading-relaxed font-medium">
                            การฝึกสมองระดับคลินิกที่ออกแบบมาเพื่อคุณโดยเฉพาะ
                        </p>
                    </div>
                    ...
                    <div className="space-y-6 pt-4">
                        <div className="flex items-center gap-4 bg-white/60 p-4 rounded-2xl shadow-sm border border-brown-900/5">
                            ...
                            <div className="text-left">
                                <h3 className="font-bold text-lg text-brown-900">เพิ่มความจำ</h3>
                                <p className="text-brown-600">ยกระดับความสามารถในการจำของคุณ</p>
                            </div>
                        </div>

                        <div className="flex items-center gap-4 bg-white/60 p-4 rounded-2xl shadow-sm border border-brown-900/5">
                            <div className="h-12 w-12 rounded-full bg-yellow-highlight/20 flex items-center justify-center flex-shrink-0">
                                <Zap className="h-7 w-7 text-yellow-600" />
                            </div>
                            <div className="text-left">
                                <h3 className="font-bold text-lg text-brown-900">ลับสมาธิ</h3>
                                <p className="text-brown-600">ปรับปรุงการใส่ใจในรายละเอียด</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 bg-white/60 p-4 rounded-2xl shadow-sm border border-brown-900/5">
                            ...
                            <div className="text-left">
                                <h3 className="font-bold text-lg text-brown-900">ติดตามความก้าวหน้า</h3>
                                <p className="text-brown-600">ดูสมองของคุณแข็งแกร่งขึ้น</p>
                            </div>
                        </div>
                    </div>
                </div>
